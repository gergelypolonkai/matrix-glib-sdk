...
MatrixRoom *
matrix_room_construct(GType object_type, const gchar *room_id)
{
    g_return_val_if_fail(room_id != NULL, NULL);

    return (MatrixRoom *)g_object_new(object_type,
                                      "room-id", room_id,
                                      NULL);
}
...
{
    return matrix_room_construct(MATRIX_TYPE_ROOM, room_id);
}
 ...
 *
 * Returns: the #MatrixProfile of the user
 */
MatrixProfile *
