...
MatrixHTTPAPI *
matrix_http_api_construct(GType object_type, const gchar *base_url, const gchar *token, const gchar *refresh_token)
{
    MatrixHTTPAPI *ret;
...
{
    return matrix_http_api_construct(MATRIX_TYPE_HTTP_API, base_url, token, refresh_token);
}
