...
MatrixMessageVideo *
matrix_message_video_construct(GType object_type)
{
    return (MatrixMessageVideo *)matrix_message_base_construct(object_type);
}

MatrixMessageVideo *
matrix_message_video_new(void) {
    return matrix_message_video_construct(MATRIX_MESSAGE_TYPE_VIDEO);
}
